...
<font color = '#d7215b'>Hint:</font> Filtro la tabla para las fechas señaladas, empleo la función `split` para guardar en una lista la información de cada una de las regiones. Con `lapply` y la función `which.min` hallo la región que presenta el minimo  
